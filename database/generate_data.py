...
# Running it twice will cause errors because some unique values will
# repeat.
...
for i in range(NUM_DOCTORS):
    ...
    cursor.execute(
        '''
        INSERT INTO doctor (full_name, specialisation, phone, email,
        licence_number)
        VALUES (%s, %s, %s, %s, %s)
        ''',
...
for i in range(NUM_PATIENTS):
    ...
    cursor.execute(
        ...
        ''',
        (name, dob, gender, phone, email, address, blood, ec_name,
        ec_phone)
    )
